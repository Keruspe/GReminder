...
#ifndef __G_REMINDER_ITEM_PRIVATE_H__
#define __G_REMINDER_ITEM_PRIVATE_H__

#include "greminder-item.h"

G_BEGIN_DECLS

typedef struct _GReminderItemPrivate GReminderItemPrivate;

struct _GReminderItem
{
    GObject parent_instance;
};

struct _GReminderItemClass
{
...
#endif /*__G_REMINDER_ITEM_PRIVATE_H__*/
