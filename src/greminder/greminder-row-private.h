...
#ifndef __G_REMINDER_ROW_PRIVATE_H__
#define __G_REMINDER_ROW_PRIVATE_H__

#include "greminder-row.h"

G_BEGIN_DECLS

typedef struct _GReminderRowPrivate GReminderRowPrivate;

struct _GReminderRow
{
    GtkListBoxRow parent_instance;
};

struct _GReminderRowClass
{
...
#endif /*__G_REMINDER_ROW_PRIVATE_H__*/
