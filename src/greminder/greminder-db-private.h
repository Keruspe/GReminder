...
#ifndef __G_REMINDER_DB_PRIVATE_H__
#define __G_REMINDER_DB_PRIVATE_H__

#include "greminder-db.h"

G_BEGIN_DECLS

typedef struct _GReminderDbPrivate GReminderDbPrivate;
...
#endif /*__G_REMINDER_DB_PRIVATE_H__*/
